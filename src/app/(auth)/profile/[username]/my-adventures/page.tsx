...
export default async function ProfileMyAdventuresPage({
  params,
}: {
  ...
  if (decodedUsername !== username) {
    redirect(`/profile/${encodeURIComponent(username)}/my-adventures`)
  }
  ...
  if (!user) {
    redirect(`/login?next=/profile/${encodeURIComponent(username)}/my-adventures`)
  }
  ...
  if (!profile || profile.id !== user.id) {
    redirect('/profile/my-adventures')
  }
  ...
  return <ProfileMyAdventuresContent adventures={combined} error={adventuresError} />
}

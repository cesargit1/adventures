...
const discussions = [
  {
    id: 1,
    title: 'Mountain Expedition Safety Concerns',
    href: '#',
  ...
  {
    id: 2,
    title: 'Kayaking Equipment Requirements Update',
    href: '#',
  ...
  {
    id: 3,
    title: 'Camping Retreat Location Verification Needed',
    href: '#',
  ...
  {
    id: 4,
    title: 'Hiking Tour Guide Certification Question',
    href: '#',
  ...
  {
    id: 5,
    title: 'Adventure Pricing Review and Adjustment',
    href: '#',
...
export default function AdminAdventures() {
  return (
    <div className="py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900">Adventures Moderation</h1>
        <p className="mt-2 text-gray-600">Review and manage adventure listings</p>
      </div>

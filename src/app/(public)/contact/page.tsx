        ...
        <div className="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            ...
            <p className="mt-6 text-lg/8 text-gray-600">
              Questions about AdventuresCalendar, hosting an adventure, joining a trip, or working
              together? Send a message and we&apos;ll point you in the right direction.
            </p>
            <dl className="mt-10 space-y-4 text-base/7 text-gray-600">
              ...
              <div className="flex gap-x-4">
                ...
                <dd>
                  <a href="mailto:hello@adventurescalendar.com" className="hover:text-gray-900">
                    hello@adventurescalendar.com
                  </a>
                </dd>
              </div>
            </dl>
